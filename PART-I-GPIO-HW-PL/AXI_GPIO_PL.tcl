...
#
# AXI_GPIO_PL.tcl: Tcl script for re-creating project 'AXI_GPIO_PL'
#
# Generated by Vivado on Mon Nov 14 22:16:18 CET 2022
...
#
# 1. This project restoration tcl script (AXI_GPIO_PL.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/nicolas/sandbox/kv260/AXI-GPIO2/hardware/AXI_GPIO_PL/top.v"
#    "/home/nicolas/sandbox/kv260/AXI-GPIO2/hardware/AXI_GPIO_PL/AXI_GPIO_PL.srcs/constrs_1/new/pmod_and_fan.xdc"
#    "/home/nicolas/sandbox/kv260/AXI-GPIO2/hardware/AXI_GPIO_PL/AXI_GPIO_PL.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../AXI_GPIO_PL/top.v"]"\
 "[file normalize "$origin_dir/../AXI_GPIO_PL/AXI_GPIO_PL.srcs/constrs_1/new/pmod_and_fan.xdc"]"\
 "[file normalize "$origin_dir/../AXI_GPIO_PL/AXI_GPIO_PL.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "AXI_GPIO_PL"
...
set script_file "AXI_GPIO_PL.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../AXI_GPIO_PL"]"
...
set file "[file normalize "$origin_dir/../AXI_GPIO_PL/AXI_GPIO_PL.srcs/constrs_1/new/pmod_and_fan.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/pmod_and_fan.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *new/pmod_and_fan.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/pmod_and_fan.xdc]" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create ports
  set ALIVE [ create_bd_port -dir O ALIVE ]
  set PMOD [ create_bd_port -dir O -from 6 -to 0 PMOD ]
...
sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#sclk_out#gpio0[7]#gpio0[8]#n_ss_out[0]#miso#mosi#gpio0[12]#gpio0[13]#gpio0[14]#gpio0[15]#gpio0[16]#gpio0[17]#gpio0[18]#gpio0[19]#gpio0[20]#gpio0[21]#gpio0[22]#gpio0[23]#scl_out#sda_out#gpi[0]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpi[5]#gpo[0]#gpo[1]#gpo[2]#gpo[3]#txd#rxd#gpio1[38]#sdio1_data_out[4]#sdio1_data_out[5]#sdio1_data_out[6]#sdio1_data_out[7]#sdio1_bus_pow#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {11} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports PMOD] [get_bd_pins axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports ALIVE] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-11,-329",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port port-id_ALIVE -pg 1 -lvl 5 -x 1610 -y -180 -defaultsOSRD
preplace portBus PMOD -pg 1 -lvl 5 -x 1610 -y 180 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 340 -y 100 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -x 1450 -y 170 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 840 -y 150 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 340 -y 310 -defaultsOSRD
preplace netloc axi_gpio_0_gpio_io_o 1 4 1 N 180
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 3 660 310 N 310 1170
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 20 -10 650 300 N 300 1160
preplace netloc zynq_ultra_ps_e_0_pl_clk1 1 1 4 640 -180 NJ -180 NJ -180 NJ
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 0 630
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 2 N 150 N
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 60
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 80
levelinfo -pg 1 0 340 840 1140 1450 1610
pagesize -pg 1 -db -bbox -sgen 0 -200 1730 420
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../AXI_GPIO_PL/AXI_GPIO_PL.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/AXI_GPIO_PL.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
